"""Test-only compatibility shims for Python 3.10 dev envs.

They let the spec agent-loop tests run on openrlhf / verl conda in addition to
the py3.11 container.
